namespace AlgPlayGroundApp.LeetCode.Easy
{
    public class PalindromeNumberChecker
    {
        ...
        /// Following method checks with OUT convert number to string 
        /// </summary>
        /// <param name="x"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// worst solution
        /// convert number to string and check the string
        /// </summary>
        /// <param name="x"></param>
        /// <returns></returns>
        public bool IsPalindromeWithConvertToString(int x)
        {

            if (x < 0)
                return false;
            if (x % 10 == 0 && x != 0)
                // for example 50 does not fit the criteria
                return false;
            if (x == 0)
                return true;
